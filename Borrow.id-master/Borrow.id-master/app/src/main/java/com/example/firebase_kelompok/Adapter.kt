...
import com.example.firebase_kelompok.R
import com.example.firebase_kelompok.Show
import com.example.firebase_kelompok.Users
...
class Adapter(val mCtx: Context, val layoutResId: Int, val list: List<Users> )
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textUpdate = view.findViewById<TextView>(R.id.ButtonUpdate)
        val textDelete = view.findViewById<TextView>(R.id.ButtonDelete)
    ...
    private fun Deleteinfo(user: Users) {
        val progressDialog = ProgressDialog(context, com.google.android.material.R.style.Base_V14_Theme_MaterialComponents_Light_Dialog)
